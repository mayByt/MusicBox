...

{
  ...
  onLoad: function onLoad() {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var currentPage, _yield$httpUtils$post, _yield$httpUtils$post2, checkLoginTokenData, checkLoginTokenDataError, _yield$httpUtils$post3, _yield$httpUtils$post4, data;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
              // 判断是否登录
              ...
              uni.redirectTo({
                ...
                _httpUtils.default.postJson("/index/queryIndexSwiper"));case 13:_yield$httpUtils$post3 = _context.sent;_yield$httpUtils$post4 = _slicedToArray(_yield$httpUtils$post3, 1);data = _yield$httpUtils$post4[0];
              _this.swiperList = data.body;case 17:case "end":return _context.stop();}}}, _callee);}))();
  },

  onPullDownRefresh: function onPullDownRefresh() {var _this2 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {var _yield$httpUtils$post5, _yield$httpUtils$post6, data;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
              _this2.swiperList = [];
              // 轮播图
              _context2.next = 3;return _httpUtils.default.postJson("/index/queryIndexSwiper");case 3:_yield$httpUtils$post5 = _context2.sent;_yield$httpUtils$post6 = _slicedToArray(_yield$httpUtils$post5, 1);data = _yield$httpUtils$post6[0];
              _this2.swiperList = data.body;
