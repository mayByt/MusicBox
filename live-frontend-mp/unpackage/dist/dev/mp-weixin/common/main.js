...
/* 0 */
/*!***************************************************!*\
  !*** Z:/myWork/MusicBox/live-frontend-mp/main.js ***!
  \***************************************************/
...
var _commonUtils = _interopRequireDefault(__webpack_require__(/*! common/util/commonUtils.js */ 15));
var _httpUtils = _interopRequireDefault(__webpack_require__(/*! common/util/httpUtils.js */ 16));
var _format = _interopRequireDefault(__webpack_require__(/*! date-fns/format */ 17));
var _subDays = _interopRequireDefault(__webpack_require__(/*! date-fns/subDays */ 50));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};} // @ts-ignore
wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;
_vue.default.config.productionTip = false;

// 日期格式化
_vue.default.filter('dateFormat', function (value) {var formatStr = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'yyyy-MM-dd';
  value = new Date(value);
  return (0, _format.default)(value, formatStr);
});

// 日期中文格式化
_vue.default.filter('chineseDateFormat', function (value) {
  value = new Date(value);
  var dateStr = (0, _format.default)(value, 'yyyy-MM-dd');

  var today = new Date();
  var todayStr = (0, _format.default)(today, 'yyyy-MM-dd');

  var yesterday = (0, _subDays.default)(today, 1);
  var yesterdayStr = (0, _format.default)(yesterday, 'yyyy-MM-dd');
  ...
  if (dateStr === todayStr) {
    ...
    dateStr = (0, _format.default)(value, 'MM月dd日');
  } else {
    dateStr = (0, _format.default)(value, 'yyyy年MM月dd日');
  }
  return dateStr;
});

// 时间中文格式化
_vue.default.filter('chineseTimeFormat', function (value) {
  value = new Date(value);
  var dateStr = (0, _format.default)(value, 'yyyy-MM-dd');
  ...
  if (dateStr === todayStr) {
    dateStr = (0, _format.default)(value, 'HH:mm');
  } else if (dateStr === yesterdayStr) {
    dateStr = "昨天" + (0, _format.default)(value, 'HH:mm');
  } else if (dateStr.slice(0, 4) === todayStr.slice(0, 4)) {
    dateStr = (0, _format.default)(value, 'MM月dd日');
  } else {
    dateStr = (0, _format.default)(value, 'yyyy年MM月dd日');
...
// 获取登录用户
_vue.default.prototype.getLoginUser = function () {
  return uni.getStorageSync("loginUser");
};

// 设置登录用户
_vue.default.prototype.setLoginUser = function (loginUser) {
  uni.setStorageSync("loginUser", loginUser);
};

// 获取当前页面路径
_vue.default.prototype.getCurrentPage = function (pages) {
  var page = pages[pages.length - 1];
  var route = page.route;
  var options = page.options;
  var result = "/" + route;
  if (options && Object.keys(options).length > 0) {
    result = result + "?" + _commonUtils.default.objectToParamString(options);
  }
  return result;
};

// 点击用户头像
_vue.default.prototype.clickUser = function (entityType, entity) {
  var str = "";
  ...
  uni.showActionSheet({
    itemList: [str],
    success: function () {var _success = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(res) {var messageName;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:if (!
                entity.hasFollowed) {_context.next = 6;break;}_context.next = 3;return (
                  _httpUtils.default.postJson("/follow/cancelFollow", {
                    targetType: 'USER',
                    targetId: entity.userId }));case 3:

                uni.showToast({
                  title: "已取消关注",
                  duration: 2000 });_context.next = 9;break;case 6:_context.next = 8;return (


                  _httpUtils.default.postJson("/follow/follow", {
                    targetType: 'USER',
                    targetId: entity.userId }));case 8:

                uni.showToast({
                  title: "已关注",
                  duration: 2000 });case 9:
                ...
                uni.$emit(messageName, {
                  id: entity.id,
                  hasFollowed: !entity.hasFollowed });case 13:case "end":return _context.stop();}}}, _callee);}));function success(_x) {return _success.apply(this, arguments);}return success;}() });
...
/* 9 */
/*!***************************************************!*\
  !*** Z:/myWork/MusicBox/live-frontend-mp/App.vue ***!
  \***************************************************/
/*! no static exports found */
...
/* 10 */
/*!****************************************************************************!*\
  !*** Z:/myWork/MusicBox/live-frontend-mp/App.vue?vue&type=script&lang=js& ***!
  \****************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 11 */
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!Z:/myWork/MusicBox/live-frontend-mp/App.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 12 */
/*!************************************************************************************!*\
  !*** Z:/myWork/MusicBox/live-frontend-mp/App.vue?vue&type=style&index=0&lang=css& ***!
  \************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 13 */
/*!****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--6-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--6-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--6-oneOf-1-2!./node_modules/postcss-loader/src??ref--6-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!Z:/myWork/MusicBox/live-frontend-mp/App.vue?vue&type=style&index=0&lang=css& ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
